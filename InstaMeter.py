...
class InstaMeter:
    ...
    def __get_profile_rest_posts(self):
        while self.__tmp_req_info['has_next_page']:
            ...
            for post in self.__tmp_data:
                ...
                try:
                    tmp_post['thumbnail_resources'] = post['thumbnail_resources']
    ...
    def __sort_posts(self, key):
        ...
        posts = [post for post in tmp_posts if post[key] > 0]
    ...
    def get_account_statistic(self, getting=True):
    ...
    def print_top_liked(self, count=10):
        print(len(self.top_posts_liked))
